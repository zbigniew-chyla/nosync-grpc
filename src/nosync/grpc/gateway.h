...
/*!
Gateway for gRPC services, with its own completion queue and dedicated thread for handling it.
*/
...
protected:
    gateway(os::mt_event_loop &evloop, std::shared_ptr<::grpc::ChannelInterface> channel);
...
/*!
Create a gateway for gRPC services that will use specified channel for all communication.
*/
